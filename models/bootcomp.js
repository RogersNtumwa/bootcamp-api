...
bootcompSchema.pre("save", async function (next) {
...
// cascade delete courses when boocamp is deleted
bootcompSchema.pre("remove", async function (next) {
  await this.model("Course").deleteMany({ bootcamp: this._id });
  next();
});

// Reverse populate with virtuals
bootcompSchema.virtual("courses", {
  ref: "Course",
  localField: "_id",
